...
public class TextConverterClient {
    ...
    public static void main(String[] args) {
        ...
        RequestText request = RequestText.newBuilder().setInputText("grpc rocks").build();

        RequestText request2 = RequestText.newBuilder().setInputText("the first character to upper").build();
